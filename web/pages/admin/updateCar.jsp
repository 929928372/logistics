	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="border_gray">
				<form action="adminServlet?action=updateCar&id=${requestScope.id}" method="post" class="form-horizontal">
					<!--第一行-->
					<div class="row">
						<label class="col-xs-4 control-label">姓名：</label>
						<div class="col-xs-3 sp1">
							<input type="text" class="form-control" name="username" value="${requestScope.car.username}" placeholder="必填" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-3 sp1">
							<input type="text" class="form-control" name="user_number" value="${requestScope.car.user_number}" placeholder="必填" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-3 sp1">
							<input type="text" class="form-control" name="address" value="${requestScope.car.address}" placeholder="必填" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-3 sp1">
							<input type="text" class="form-control" name="car_number" value="${requestScope.car.car_number}" placeholder="必填" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-3 sp1">
							<input type="text" class="form-control" name="tel" value="${requestScope.car.tel}" placeholder="必填" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-5 sp1">
							<textarea class="form-control sp4" name="car_road" rows="5" cols="20"
								placeholder="必填">${requestScope.car.car_road}</textarea>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-5 sp1">
							<textarea class="form-control sp4" name="car_content" rows="5"
								placeholder="选填">${requestScope.car.car_content}</textarea>
						</div>
					</div>

					<div class="row">
						<div class="col-xs-3 col-xs-offset-5 sp1">
							<input class="btn btn-default" type="submit" id="ok" value="确定">
